...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private SamplePresenter.SampleView sampleView;
    ...
    String url = "http://192.168.10.116/integrate/location1.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx0.setText(mStudentProduct.getUname());
                    ...
                    if (checkPlayService()) {
                        ...
                        geoService.setLocationChangeListener(new GeoService.LocationChangeListener() {
                            ...
                            public void onLocationChange(Location location) {
                              ...
                              //  yourLocation=location.getLatitude() + ", " + location.getLongitude();
    ...
    public String getText() {
        return locationText1.getText().toString();
    }

    public void setText(String newValue) {
        locationText1.setText(newValue);
    }
    ...
    private void insertData(String uname,String lng) {
        try {
            RequestQueue requestQueue = Volley.newRequestQueue(this);

            JSONObject jsonBody = new JSONObject( );
            jsonBody.put("txt0",uname);

            jsonBody.put("locationtext", lng);
    ...
    private String setUpdateLocation() {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dangerous_area = new LatLng(13.0677, 77.5043);
        ...
        public void startService(LatLng latLng, double radius) {
            ...
            geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
                ...
                public void onKeyEntered(String key, GeoLocation location) {
                    sendNotification("MAP", String.format("%s entered the college area", key));
                }

                @Override
                public void onKeyExited(String key) {
                    sendNotification("MAP", String.format("%s exit the college area", key));
                }

                @Override
                public void onKeyMoved(String key, GeoLocation location) {
                    Log.d("MOVE", String.format("%s move within the college area [%f/%f]", key, location.latitude, location.longitude));
                }
