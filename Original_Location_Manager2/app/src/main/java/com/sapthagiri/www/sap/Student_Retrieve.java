...
public class Student_Retrieve extends AppCompatActivity  implements Fragment_Drawer.OnDrawerListener {
  ...
  //  Fragment_Drawer drawerFragment;
    ...
    private TextView tx1,tx2,tx3,tx4,tx5,tx6,tx7,tx8,tx0,tx9;
   ...
   // RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx1.setText(mStudentProduct.getUname());
        tx2.setText(mStudentProduct.getEma());
        tx3.setText(" "+mStudentProduct.getMnum());
        tx4.setText(mStudentProduct.getDob());
        tx5.setText(mStudentProduct.getGen());
        tx6.setText(mStudentProduct.getBran());
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new product(
                                        Faculty_Product.getString("u.username"),
                                        Faculty_Product.getString("u.email"),
                                        Faculty_Product.getInt("u.mobile_num"),
                                        Faculty_Product.getString("u.dob"),
                                        Faculty_Product.getString("u.gender"),
                                        Faculty_Product.getString("u.branch"),
                                        Faculty_Product.getString("s.semister"),
                                        Faculty_Product.getString("s.section")
