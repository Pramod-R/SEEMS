...
import static com.sapthagiri.www.sap.Student_Attend_Retrieve.mAttendProduct;
import static com.sapthagiri.www.sap.Student_Result_Retrieve.mResultProduct;
...
public class Student_Event_Retrieve extends AppCompatActivity  implements Fragment_Drawer.OnDrawerListener {
    ...
    private static final String URL_PRODUCTS="http://192.168.10.41/SAS/API/Notice_Retrieve.php";
    ...
    private void loadProducts() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_PRODUCTS,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("semister", mStudentProduct.getSem());
               params.put("section",mStudentProduct.getSec());
                params.put("branch",mStudentProduct.getBran());
                return params;
            }
